dodekduo_Puzzle1_Gen(Solution,MinColor,MaxColor):-
...
all_different(PentaA),
all_different(PentaB),
all_different(PentaC),
all_different(PentaD),
all_different(PentaE),
all_different(PentaF),
all_different(PentaG),
all_different(PentaH),
all_different(PentaI),
all_different(PentaJ),
all_different(PentaL),
all_different(PentaM),
...
MaxColor2 is MaxColor+1,
forceColors(AllElements,MaxColor2,1),
...
if_then_else(dodekduo_Puzzle1_Sol(NewSolution,Problem,MaxColor,1),continueplay,(nl,nl,write('No More Solutions!!!'),nl,nl)),
