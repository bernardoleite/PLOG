dodekduo_Puzzle1_Sol(Solution,Pentagons,NrColors,Input):-
...
%Two faces that are adjacent must have the same color
		...
		if_then_else(Input=0, (A1#=1 , A2#=2 , A3#=3 , A4#=4 , A5#=5), continueplay),
...
domain(Face1,1,NrColors),
domain(Face2,1,NrColors),
domain(Face3,1,NrColors),
domain(Face4,1,NrColors),
domain(Face5,1,NrColors),
domain(Face6,1,NrColors),
domain(Face7,1,NrColors),
domain(Face8,1,NrColors),
domain(Face9,1,NrColors),
domain(Face10,1,NrColors),
domain(Face11,1,NrColors),
domain(Face12,1,NrColors),
...
write('-> Nr of Colors: '), write(NrColors),nl,
